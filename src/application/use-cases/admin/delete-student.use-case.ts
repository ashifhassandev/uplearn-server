...
import { IDeleteStudentUseCase } from "../../ports/use-cases/admin/delete-student.use-case.interface";
...
export class DeleteStudentUseCase implements IDeleteStudentUseCase {
  ...
  async execute(input: UpdateUserStatusInputDTO): Promise<void> {
    this.log.attempt(LOG_ACTION.DELETE_STUDENT, { userId: input.userId });
    ...
    this.log.success(LOG_ACTION.DELETE_STUDENT, { userId: input.userId });
  }
}